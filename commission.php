...
<head>
  ...
  <title>Commission Login Screen</title>
  <!-- Favicon -->
...
<body>
  <div class="main-content">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <h3 style="color: #343A40;" class="new-font">Commission Login Screen <i class="fas fa-info-circle"></i></h3>
            </div>
          </div>
        </div>
      </div>
              ...
              <form method="POST" action="process/commission_login.php">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input name="commission_number" class="form-control" placeholder="Commission Number" type="text" required>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input name="commission_password" class="form-control" placeholder="Password" type="password" required>
                  </div>
                </div>
                <div class="text-center">
                  <button type="submit" name="commission-login-btn" class="btn btn-success my-4"><i class="fas fa-sign-in-alt"></i> Commission Login</button>
                </div>
    ...
    <section id="about">
      <center>
        <h1 style="font-size:30px ;color:#54B435;" class="new-font mb-6">What Can You Do<i class="fas fa-question-circle"></i></h1>
      </center>
      <div class="row">
        <div class="col-lg-4">
          <div class="card">
            <center>
              ...
              <h4 class="new-font">Internship 1 Tracking</h4>
            </center>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="card">
            <center>
              ...
              <h4 class="new-font">Internship 2 Tracking</h4>
            </center>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="card">
            <center>
              ...
              <h4 class="new-font">IME Tracking</h4>
            </center>
          </div>
        </div>
      </div>
